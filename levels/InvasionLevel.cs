...
public sealed class InvasionLevel() : Level("invasion")
{
    protected override void LoadObjects()
    {
        ...
        Assault assault1 = new Assault(["Incoming threat!", "First threat cleared"])
            ...
            .AddWave(new Wave(10f).Group('g', 10).Group('r', 2));
        ...
        Assault assault2 = new Assault(["More incoming!", "Second threat cleared"])
            ...
            .AddWave(new Wave(10f).Group('g', 10).Group('r', 2).Group('s', 1));

        Assault assault3 = new Assault(["Large group closing in!", "Third threat cleared"])
            .AddWave(new Wave(0f).Group('g', 17).Group('r', 3).Group('s',2))
            .AddWave(new Wave(20f).Group('g', 17).Group('r', 3).Group('s', 2));
        
        Assault assault4 = new Assault(["They're coming fast!\nBe ready!", "Fourth threat cleared"])
            .AddWave(new Wave(0f).Group('g', 5).Group('r', 1))
            .AddWave(new Wave(1.5f).Group('g', 6).Group('r', 1))
            .AddWave(new Wave(1.5f).Group('g', 6).Group('r', 1))
            .AddWave(new Wave(1f).Group('g', 7).Group('r', 1))
            .AddWave(new Wave(1f).Group('g', 7).Group('r', 1))
            .AddWave(new Wave(1f).Group('g', 10).Group('r', 3));

        Assault assault5 = new Assault(["Even more on their way!", "Fifth threat cleared"])
            .AddWave(new Wave(0f).Group('g', 12).Group('r', 2))
            .AddWave(new Wave(8f).Group('g', 12).Group('s', 1))
            .AddWave(new Wave(8f).Group('g', 12).Group('s', 1))
            .AddWave(new Wave(8f).Group('g', 12).Group('s', 1).Group('r', 2));
        
        Assault assault6 = new Assault(["A whole bunch now!", "Sixth threat cleared"])
            .AddWave(new Wave(0f).Group('g', 15).Group('r', 3).Group('s', 1))
            .AddWave(new Wave(6f).Group('g', 15).Group('r', 4).Group('s', 2));

        Assault assault7 = new Assault(["This is the last of them!\nTake them out!", "Well done pilot!"])
            .AddWave(new Wave(0f).Group('g', 20).Group('r', 5).Group('s', 3))
            .AddWave(new Wave(15f).Group('g', 20).Group('r', 5).Group('s', 3))
            .AddWave(new Wave(15f).Group('g', 30).Group('r', 5).Group('s', 3));
